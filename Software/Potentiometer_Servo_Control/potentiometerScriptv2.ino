...
// Potentiometer (Updated for Port 14)
const int potPin = 14;
...
// ════════════════════════════════════════════════════════════
// Point PCA9685 to Wire1 for Teensy pins 16 & 17
...
void setup() {
  ...
  // Start the secondary I2C bus on pins 16 (SCL1) and 17 (SDA1)
  Wire1.begin();
